...
public class RandomWalk
{
    ...
    private static bool GetCorridorFloorCells(Vector3Int room1CorridorCell, Vector3Int room2CorridorCell, TilemapHelper.Edge room1Edge, out List<Vector3Int> corridorFloorCells, int maxIterations = 50, int maxConnectionFail = 5)
    {
    ...
    /// <returns></returns>
    public static List<Vector3Int> GetCorridorFloorCells(Vector3Int room1CorridorCell, TilemapHelper.Edge room1Edge, DungeonRoomInstance room2Instance ,int maxIterations = 3, int maxConnectionFail = 5)
    {
        if (room2Instance == null || room2Instance.wallMap == null) return null;

        // list to contain the floor cells
        List<Vector3Int>  corridorFloorCells = new List<Vector3Int>();
    ...
    private static void AddNewFloorCells(ref Vector3Int currCell, int steps, Vector2Int dir, List<Vector3Int> corridorFloorCells)
    {

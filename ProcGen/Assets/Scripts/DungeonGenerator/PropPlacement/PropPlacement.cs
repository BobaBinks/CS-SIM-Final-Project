...
{
    public static bool PlaceProps(Dictionary<DungeonRoom, DungeonRoomInstance> roomsDict, List<GameObject> propPrefabs, List<GameObject> chestPrefabs, int maxAttempts = 5)
    {
        if (roomsDict == null || roomsDict.Count == 0 || propPrefabs == null || propPrefabs.Count == 0 || chestPrefabs == null || chestPrefabs.Count == 0)
        {
